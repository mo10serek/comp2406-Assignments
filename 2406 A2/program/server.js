...
http.createServer(function(request, response) {
    ...
    request.on("end", function() {
      ...
      if (request.method == "POST") {
        ...
        } else if (dataObj.type == "give song") {
            name = 'songs/' + dataObj.text + '.txt'
            fs.writeFile(name, dataObj.sheet,function(err, data){console.log('done')})
        }
      }
